...
class CoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cour" do
    assert_difference("Cour.count") do
      post cours_url, params: { cour: { description: @cour.description, formation_id: @cour.formation_id, title: @cour.title } }
    end
  ...
  test "should update cour" do
    patch cour_url(@cour), params: { cour: { description: @cour.description, formation_id: @cour.formation_id, title: @cour.title } }
